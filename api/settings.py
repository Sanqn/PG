...
SECRET_KEY = 'django-insecure-sp^10ag0t0chc^-66t6((&2czmqte23-u-5-0dj%1$_c5ih2#-'
...
DJOSER = {
    ...
    'TOKEN_MODEL': None,
    'SERIALIZERS': {
        'user_create': 'testapi.serializers.RegisterSerializer',
        'user': 'testapi.serializers.RegisterSerializer',
    },
}
